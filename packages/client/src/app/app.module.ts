...
import { BlogFormComponent, ContentItemComponent, PoetryFormComponent, ProseFormComponent } from './pages/portfolio/my-stuff';
...
@NgModule({
  declarations: [
    ...
    ContentItemComponent, ProseFormComponent, PoetryFormComponent
  ],
  imports: [
