...
import { BlogFormComponent, NewFolderComponent, FolderPageComponent, ContentItemComponent } from './pages/portfolio/my-stuff';
...
@NgModule({
  declarations: [
    ...
    NewFolderComponent, FolderPageComponent, ContentItemComponent
  ],
  imports: [
