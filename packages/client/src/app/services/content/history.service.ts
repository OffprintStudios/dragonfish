...
export class HistoryService {
    ...
    public fetchUserHistory(pageNum: number) {
        return this.http
            .get<PaginateResult<ReadingHistory>>(`${this.url}/fetch-user-history/${pageNum}`, {
                observe: 'response',
    ...
    public fetchUserSidenavHistory() {
        return this.http
            .get<ReadingHistory[]>(`${this.url}/fetch-user-sidenav-history`, {
                observe: 'response',
                withCredentials: true,
            })
            .pipe(
    ...
    public fetchOneHistDoc(workId: string) {
        return this.http
            .get<ReadingHistory>(`${this.url}/fetch-one-hist-doc/${workId}`, {
                observe: 'response',
                withCredentials: true,
            })
            .pipe(
    ...
    public addOrUpdateHistory(workId: string) {
        return this.http
            .post<ReadingHistory>(
                `${this.url}/add-or-update-history/${workId}`,
                {},
    ...
    public changeVisibility(histId: string) {
        return this.http
            .patch<void>(
                `${this.url}/change-item-visibility/${histId}`,
                {},
                { observe: 'response', withCredentials: true },
            )
            .pipe(
