...
export class CommentsService {
    ...
    public addBlogComment(blogId: string, commentInfo: CreateComment) {
        return this.http
            .put<BlogComment>(`${this.url}/add-blog-comment/${blogId}`, commentInfo, {
                observe: 'response',
    ...
    public addWorkComment(workId: string, commentInfo: CreateComment) {
        return this.http
            .put<WorkComment>(`${this.url}/add-work-comment/${workId}`, commentInfo, {
                observe: 'response',
                withCredentials: true,
            })
            .pipe(
    ...
    public addContentComment(contentId: string, commentInfo: CreateComment) {
        return this.http
            .put<ContentComment>(`${this.url}/add-content-comment/${contentId}`, commentInfo, {
                observe: 'response',
                withCredentials: true,
            })
            .pipe(
    ...
    public getBlogComments(blogId: string, pageNum: number) {
        return this.http
            .get<PaginateResult<BlogComment>>(`${this.url}/get-blog-comments/${blogId}/${pageNum}`, {
                observe: 'response',
                withCredentials: true,
            })
            .pipe(
    ...
    public getWorkComments(workId: string, pageNum: number) {
        return this.http
            .get<PaginateResult<WorkComment>>(`${this.url}/get-work-comments/${workId}/${pageNum}`, {
                observe: 'response',
                withCredentials: true,
            })
            .pipe(
    ...
    public getContentComments(contentId: string, pageNum: number) {
        return this.http
            .get<PaginateResult<ContentComment>>(`${this.url}/get-content-comments/${contentId}/${pageNum}`, {
                observe: 'response',
                withCredentials: true,
            })
            .pipe(
    ...
    public editComment(commentId: string, commentInfo: EditComment) {
        return this.http
            .patch(`${this.url}/edit-comment/${commentId}`, commentInfo, { observe: 'response', withCredentials: true })
            .pipe(
                map(() => {
