...
export class PortfolioService {
    ...
    public getUserInfo(userId: string) {
        return this.http
            .get<FrontendUser>(`${this.url}/get-user-info/${userId}`, { observe: 'response', withCredentials: true })
            .pipe(
                map((user) => {
                    return user.body;
                }),
    ...
    public getBlogList(userId: string, pageNum: number) {
        return this.http
            .get<PaginateResult<Blog>>(`${this.url}/get-blogs-list/${userId}/${pageNum}`, {
                observe: 'response',
    ...
    public getWorksList(userId: string, pageNum: number) {
        return this.http
            .get<PaginateResult<Work>>(`${this.url}/get-works-list/${userId}/${pageNum}`, {
                observe: 'response',
                withCredentials: true,
            })
            .pipe(
    ...
    public getCollectionsList(userId: string, pageNum: number) {
        return this.http
            .get<PaginateResult<Collection>>(`${this.url}/get-port-collections/${userId}/${pageNum}`, {
                observe: 'response',
                withCredentials: true,
            })
            .pipe(
    ...
    public getOneCollection(userId: string, collId: string) {
        return this.http
            .get<Collection>(`${this.url}/get-one-collection/${userId}/${collId}`, {
                observe: 'response',
                withCredentials: true,
            })
            .pipe(
    ...
    public getBlog(blogId: string) {
        return this.http
            .get<Blog>(`${this.url}/get-blog/${blogId}`, { observe: 'response', withCredentials: true })
            .pipe(
                map((blog) => {
                    return blog.body;
                }),
