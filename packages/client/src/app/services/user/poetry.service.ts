...
export class PoetryService {
    ...
    public createPoetry(poetryInfo: CreatePoetry) {
        return this.http
            .put<PoetryContent>(`${this.url}/create-poetry`, poetryInfo, { observe: 'response', withCredentials: true })
            .pipe(
                map((res) => {
                    return res.body;
                }),
    ...
    public editPoetry(contentId: string, poetryInfo: CreatePoetry) {
        return this.http
            .patch<PoetryContent>(`${this.url}/edit-poetry?contentId=${contentId}`, poetryInfo, {
                observe: 'response',
