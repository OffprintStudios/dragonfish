...
export class ContentService {
    ...
    public fetchOne(contentId: string, kind: ContentKind): Observable<ContentModel> {
        return this.http
            .get<ContentModel>(`${this.url}/fetch-one-published?contentId=${contentId}&kind=${kind}`, {
                observe: 'response',
    ...
    public fetchRelatedHistory(contentId: string) {
        return this.http
            .post<ReadingHistory>(
                `${this.url}/history/add-or-update-history/${contentId}`,
                {},
    ...
    public fetchAll(pageNum: number, kinds: ContentKind[], userId?: string): Observable<PaginateResult<ContentModel>> {
        ...
        return this.http
            .get<PaginateResult<ContentModel>>(route, { observe: 'response', withCredentials: true })
            .pipe(
                map((res) => {
                    return res.body;
                }),
    ...
    public fetchSection(sectionId: string): Observable<Section> {
        return this.http
            .get<Section>(`${this.url}/sections/fetch-one-by-id?sectionId=${sectionId}&published=true`, {
                observe: 'response',
                withCredentials: true,
            })
            .pipe(
    ...
    public setLike(setRating: SetRating): Observable<ReadingHistory> {
        return this.http
            .patch<ReadingHistory>(`${this.url}/set-like`, setRating, { observe: 'response', withCredentials: true })
            .pipe(
                map((res) => {
                    return res.body;
                }),
    ...
    public setDislike(setRating: SetRating): Observable<ReadingHistory> {
        return this.http
            .patch<ReadingHistory>(`${this.url}/set-dislike`, setRating, { observe: 'response', withCredentials: true })
            .pipe(
                map((res) => {
                    return res.body;
                }),
    ...
    public setNoVote(setRating: SetRating): Observable<ReadingHistory> {
        return this.http
            .patch<ReadingHistory>(`${this.url}/set-no-vote`, setRating, { observe: 'response', withCredentials: true })
            .pipe(
                map((res) => {
                    return res.body;
                }),
