...
export class MyStuffService {
    ...
    public fetchOne(contentId: string, kind: ContentKind): Observable<ContentModel> {
        return this.http
            .get<ContentModel>(`${this.url}/fetch-one?contentId=${contentId}&kind=${kind}`, {
                observe: 'response',
    ...
    public createContent(
        ...
        return this.http
            .put<ContentModel>(`${this.url}/create-one?kind=${kind}`, formInfo, {
                observe: 'response',
                withCredentials: true,
            })
            .pipe(
    ...
    public saveContent(
        ...
        return this.http
            .patch<ContentModel>(`${this.url}/save-changes?contentId=${contentId}&kind=${kind}`, formInfo, {
                observe: 'response',
                withCredentials: true,
            })
            .pipe(
    ...
    public publishOne(contentId: string, pubChange?: PubChange): Observable<ContentModel> {
        return this.http
            .patch<ContentModel>(`${this.url}/publish-one?contentId=${contentId}`, pubChange, {
                observe: 'response',
                withCredentials: true,
            })
            .pipe(
    ...
    public fetchSections(contentId: string): Observable<Section[]> {
        return this.http
            .get<Section[]>(`${this.url}/sections/fetch-user-content-sections?contentId=${contentId}`, {
                observe: 'response',
                withCredentials: true,
            })
            .pipe(
    ...
    public createSection(contentId: string, sectionInfo: SectionForm): Observable<Section> {
        return this.http
            .put<Section>(`${this.url}/sections/create-section?contentId=${contentId}`, sectionInfo, {
                observe: 'response',
                withCredentials: true,
            })
            .pipe(
    ...
    public editSection(contentId: string, sectionId: string, sectionInfo: SectionForm): Observable<Section> {
        return this.http
            .patch<Section>(
                `${this.url}/sections/edit-section?contentId=${contentId}&sectionId=${sectionId}`,
                sectionInfo,
    ...
    public deleteSection(contentId: string, sectionId: string): Observable<Section> {
        return this.http
            .patch<Section>(
                `${this.url}/sections/delete-section?contentId=${contentId}&sectionId=${sectionId}`,
                {},
                { observe: 'response', withCredentials: true },
            )
            .pipe(
    ...
    public publishSection(contentId: string, sectionId: string, pubStatus: PublishSection): Observable<Section> {
        return this.http
            .patch<Section>(
                `${this.url}/sections/publish-section?contentId=${contentId}&sectionId=${sectionId}`,
                pubStatus,
                { observe: 'response', withCredentials: true },
            )
            .pipe(
