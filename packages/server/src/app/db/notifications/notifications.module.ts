...
@Module({
  ...
  providers: [NotificationsService,  
    ...NotificationQueueSubSchemaProviders,  
    ...NotificationSubSchemaProviders
],
 ...
 */
export function getSubSchemaProvider<T extends Document>(token: string, parentToken: string, subSchemaFunction: (notificationModel: Model<T>) => Model<T>): Provider {
  return {
