<script lang="ts">
  ...
  import { close, guide } from "./guide.state";
...
<style lang="scss">
  div.guide {
    @apply h-screen z-40 relative min-w-full max-w-full md:min-w-[24rem] md:max-w-[24rem] md:rounded-r-2xl overflow-hidden md:border-r-4;
