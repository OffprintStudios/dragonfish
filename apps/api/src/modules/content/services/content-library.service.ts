...
import { AddedToLibraryPayload, SubscriptionPayload } from '$shared/models/notifications/payloads';
import {
    NotificationKind,
    SubscriptionEvent,
    SubscriptionKind,
} from '$shared/models/notifications';
import { BookshelfForm, ContentRemovalJob } from '$shared/models/content-library';
...
export class ContentLibraryService {
    ...
    public async fetchOne(pseudId: string, contentId: string) {
        return await this.libraryStore.fetchOne(pseudId, contentId);
    }
