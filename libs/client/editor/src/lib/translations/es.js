!(function (e) {
    ...
    (a.dictionary = Object.assign(a.dictionary || {}, {
        ...
        'Color picker': '',
        Column: 'Columna',
        'Could not insert image at the current position.': 'No se puede insertar una imagen en la posición actual',
        'Could not obtain resized image URL.': 'No se puede acceder a la URL de la imagen redimensionada',
        Dashed: '',
        Decimal: '',
        ...
        'Inserting image failed': 'Error insertando imagen',
        Inset: '',
        Italic: 'Cursiva',
        Justify: 'Justificar',
        'Justify cell text': '',
        ...
        'Select column': '',
        'Select row': '',
        'Selecting resized image failed': 'Fallo eligiendo imagen redimensionada',
