...
import { AddedToLibraryJob } from '@dragonfish/shared/models/accounts/notifications/jobs';
import { NotificationKind } from '@dragonfish/shared/models/accounts/notifications';

@Injectable()
export class AddedToLibraryStore {
    constructor(
        @InjectModel(NotificationKind.AddedToLibrary) private readonly addedToLibrary: Model<AddedToLibraryDocument>,
    ) {}
